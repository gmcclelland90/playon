...
5. Use the **Model** chooser for installed tags, or **Pull** a suggested model (`qwen2.5`, `llama3.2`, `mistral`, …). `qwen2.5` is the Settings default (llama3.2 has no native tools).
