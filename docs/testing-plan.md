...
- Node-agent OTA / parent restart must not stop a supervised native (or docker) child — unit-covered in `@playon/runtime` + `@playon/node-agent` ([#886](https://github.com/gmcclelland90/playon/issues/886))
