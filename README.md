...
Maintainers / CI: bump version + CHANGELOG, tag `vX.Y.Z` — see **[docs/release.md](docs/release.md)** (packages Home/Node, publishes GitHub Release, syncs `/home/latest.json` to playon.games, deploys Pages). Operating loop (issues → agents → verify → ship): **[docs/sdlc.md](docs/sdlc.md)**.
