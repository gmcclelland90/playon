...
export const AGENT_SYSTEM_PROMPT = [
  ...
  "Placement: if placement_suggest has no eligible node (os_mismatch, docker_required, no_eligible_node), do not create anyway — explain the gap and offer nodes_add (Linux LAN/cloud) or the host's Linux runtime enable path when available. Never force an ineligible nodeId.",
